        ...
        <section class="py-16">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
              <h2 class="text-3xl font-bold mb-4">Choose the perfect plan for your needs</h2>
            ...
            <!-- Pricing Cards -->
            <div id="plans" class="grid gap-8 lg:grid-cols-3"></div>
            ...
            plans.forEach(plan => {
              ...
              card.innerHTML += `
                ...
                <div class="mt-6 flex-1 flex flex-col justify-between">
                  ...
                  <button onclick="window.location.href='{{ route('billing') }}'" class="w-full px-4 py-2 rounded-lg ${
