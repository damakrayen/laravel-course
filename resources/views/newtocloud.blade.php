          ...
          <div class="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                  ...
                  <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('upload') }}"
                    class="bg-blue-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-100 hover:text-dark transition-colors shadow-lg">
                     Start Uploading
                 </a>
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-gray-50 rounded-2xl p-8">
                ...
                <p class="text-gray-700 mb-4">
                  "I'd never used the cloud before. The team guided me every step of the way.
            ...
            <div class="bg-gray-50 rounded-2xl p-8">
                ...
                <p class="text-gray-700 mb-4">
                  "Safety was my main concern. After two years of use,
            ...
            <div class="bg-gray-50 rounded-2xl p-8">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h4 class="font-semibold">Sophie Laurent</h4>
                        <p class="text-gray-600 text-sm">Photograph</p>
                    </div>
                ...
                <p class="text-gray-700 mb-4">
                  "My photos are now safe and secure, and I can access them from
                  anywhere. It's revolutionary!"
                </p>
  ...
  <section class="py-20  from-primary to-secondary">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
              <button class="bg-blue text-primary px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg" onclick="window.location.href='{{ route('upload') }}'">
                  Start Uploading
              </button>
              <button class="bg-blue text-primary px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg"onclick="window.location.href='{{ route('demo') }}'">
                  Schedule Demo
              </button>
          </div>
